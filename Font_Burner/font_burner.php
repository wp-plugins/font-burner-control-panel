...
function addFontburner() {
	...
	echo '/wp-content/plugins/Font_Burner/css/fontburner.css" type="text/css" media="screen" />
	<link rel="wpurl" href="';
	echo get_bloginfo('stylesheet_directory'); 
	echo '/wp-content/plugins/Font_Burner/css/fontburner_print.css" type="text/css" media="print" />
	<script src="';
	echo get_bloginfo('wpurl'); 
	echo'/wp-content/plugins/Font_Burner/js/fontburner.js" type="text/javascript"></script> 
